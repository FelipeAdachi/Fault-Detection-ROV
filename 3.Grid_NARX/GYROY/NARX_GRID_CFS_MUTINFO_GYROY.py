...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 11:33:15 2019
...
train_file='/Train_'
val_file='/Validate_'
filename='/home/felipeadachi/Dados/Kfolds_cpu/Models_GridSearch/GYROY/CFS_MUTINFO/log_narx.txt'
path_models='/home/felipeadachi/Dados/Kfolds_cpu/Models_GridSearch/GYROY/CFS_MUTINFO'
...
def main():
    ...
    for combination in list(product(*param_grid.values())):
        ...
        for train_index, validate_index in kf.split(df):        
            ...
            #Get number of feature in each fold
