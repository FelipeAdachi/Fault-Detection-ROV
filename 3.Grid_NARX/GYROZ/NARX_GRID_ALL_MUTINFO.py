...
train_file='/Train_'
val_file='/Validate_'
filename='/home/felipeadachi/Dados/Kfolds_cpu/Models_GridSearch/ALL_MUTINFO/log_narx.txt'
path_models='/home/felipeadachi/Dados/Kfolds_cpu/Models_GridSearch/ALL_MUTINFO'
    ...
    for combination in list(product(*param_grid.values())):
        ...
        for train_index, validate_index in kf.split(df):        
            ...
            if i==1 or i==3 or i==4:
                ...
                models[i-1].add(Dense(34, input_dim=34, kernel_initializer='uniform', activation='tanh'))
