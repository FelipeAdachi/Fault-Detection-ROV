...
def main():
    ...
    for fault_type in fault_types:
        ...
        for col, style in zip(df.columns, styles):
            df[col].plot(style=style,linewidth=3,xticks=[10,25,50,100],ylim=(-0.02,1.05),xlim=(8,103),label=col, ax=ax)
        ...
        plt.show()
        #df.plot(style='.--',xticks=[10,25,50,100],ylim=(-5,100),xlim=(8,103),ax=axes[k],title=titles[k])
        
# =============================================================================
#         df.plot(style='.--',xticks=[10,25,50,100],ylim=(-0.02,1.05),xlim=(8,103))
#         
#         
#         plt.xticks([10, 25, 50, 100],
#            ["10\n(2s)", "25\n(5s)", "50\n(10s)", "100\n(20s)"])
